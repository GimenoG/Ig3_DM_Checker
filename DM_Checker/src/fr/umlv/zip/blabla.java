...
/*	private final static int BUFFER_SIZE = 2048;
	private final static String ZIP_FILE = "/Users/Gui/Documents/Lambda/Archive2.zip";
	private final static String DESTINATION_DIRECTORY = "/Users/Gui/Documents/Lambda/multi";
			...
			while (zipFileEntries.hasMoreElements()) {
				...
				if (!entry.isDirectory()) {
					...
					if (entry.getName().toLowerCase().endsWith(ZIP_EXTENSION)) {
						String zipFilePath = destDirectory.getPath()
								+ File.separatorChar + entry.getName();

						unzipToFile(
								zipFilePath,
								zipFilePath.substring(0, zipFilePath.length()
	...
	public static void doIt(){
	     ...
	     ReadingArchive unzip = new ReadingArchive();  
